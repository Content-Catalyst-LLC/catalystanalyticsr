test_that("v1 API manifest declares stable contracts", {
  ...
  expect_identical(manifest$package$version, "2.1.0")
...
test_that("compatibility manifest maps WordPress companion", {
  ...
  expect_identical(compatibility$wordpress$version, "3.1.0")
  expect_identical(compatibility$wordpress$compatible_repository_version, "2.1.0")
