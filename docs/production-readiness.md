...
Release identity, release-readiness validation, and Workspace handoff support are aligned at package v2.0.1. Connected Platform contract versions remain v2.0.0.
