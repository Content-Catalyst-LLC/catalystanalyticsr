...
.core_provider_capabilities <- function() {
  list(
    ...
    uncertainty_analysis = list(category = "uncertainty", method_refs = c("run_uncertainty", "uncertainty_summary", "uncertainty_probabilities", "run_uncertainty_sensitivity_runtime"), input_types = c("scenario", "uncertainty_spec"), output_types = c("analytical_result", "uncertainty"), execution_status = "available"),
    sensitivity_analysis = list(category = "uncertainty", method_refs = c("local_sensitivity", "global_sensitivity", "sensitivity_jacobian", "morris_sensitivity", "sobol_sensitivity"), input_types = c("scenario", "uncertainty_run"), output_types = c("analytical_result", "sensitivity"), execution_status = "available"),
...
catalyst_core_provider_manifest <- function() {
  ...
  list(
    ...
    uncertainty_sensitivity_contract = "sc.analytics-r.uncertainty-sensitivity-runtime.v1",
