...
#'
#' Returns the v1.5.0 public API stability declaration.
...
catalyst_api_manifest <- function(include_experimental = TRUE) {
  ...
  result <- list(
    ...
    package = list(name = "catalystanalyticsr", version = "1.5.0"),
...
catalyst_compatibility_manifest <- function() {
  list(
    ...
    wordpress = list(plugin = "catalyst-analytics-r-demo", version = "2.5.0", compatible_repository_version = "1.5.0"),
